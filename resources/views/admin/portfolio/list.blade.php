                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right">
                                        <button class="btn btn-secondary" onclick="openPortfolioForm(this)">Add
                                            New</button>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add_portfolio" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group" style="width: 100%; height:150px;">
                                    <img id="portfolio_image" src="" class="img-thumbnail"
                                        style="width: 100%; height:100%; object-fit: contain;">
                                </div>
                                <div>
                                    <input
                                        type="file"onchange="document.querySelector('#portfolio_image').src=window.URL.createObjectURL(this.files[0])"
...
@section('customJs')
    ...
    <script>
        ...
        $(document).on('submit', '#add_portfolio', function(event) {
            event.preventDefault();
            $.ajax({
                url: "{{ route('admin_portfolio_addEdit') }}",
                method: 'POST',
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $.each(data, function(key, value) {
                            if (key == "image") {
                                $("#portfolio_image").attr("src", "{{ asset('manual_storage/') }}/" +
                                    value);
                            } else {
                                $('#add_portfolio [name="' + key + '"]').val(value);
                            }
                        });
                    }
                });
        ...
        function lolad_datatable() {
            $('#basic_datatable').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: "{{ route('admin_portfolio_fetchAllList') }}",
                    type: "POST",
                    data: {}
                },
                "columnDefs": [{
        ...
        function updateStatus(id) {
            ...
            webinaFire({
                ...
                accept: function() {
                    ...
                    $.ajax({
                        url: "{{ route('admin_portfolio_status') }}",
                        method: 'POST',
                        data: {
                            id: id,
                            status: status
        ...
        function deletePortfolio(id) {
            ...
            webinaFire({
                ...
                accept: function() {
                    $.ajax({
                        url: "{{ route('admin_portfolio_delete') }}",
                        type: 'delete',
                        data: {
                            id: id
                        },
